...
export const TopClothes = [
    ...
    { ko: "긴팔 원피스", en: Clothes.LONG_SLEEVE_DRESS },
    ...
    { ko: "청자켓", en: Clothes.JACKET_DENIM },
...
export const BoyClothesPath: { [key in Clothes]?: ImageSourcePropType } = {
    ...
    [Clothes.SHORT_PANTS]: require("asset/image/clothes/girl/image_shorts_pants.png")
}

export const GirlClothesPath: { [key in Clothes]?: ImageSourcePropType } = {
    ...
    [Clothes.COAT_BROWN]: require("asset/image/clothes/girl/image_coat_gray.png"),
    ...
    [Clothes.LONG_PANTS_JEAN_BLACK]: require("asset/image/clothes/image_long_pants_jean_black.png"),
    [Clothes.LONG_PANTS_JEAN_DENIM]: require("asset/image/clothes/image_long_pants_jean_denim.png"),
    // [Clothes.SHORT_SLEEVE_SHIRTS_NAVY]: require("asset/image/clothes/girl/image_short.png"),
    ...
    [Clothes.JACKET_PUFFY]: require("asset/image/clothes/girl/image_hoody_jacket_sherpa.png"),
    ...
    [Clothes.LONG_SLEEVE_DRESS]: require("asset/image/clothes/girl/image_short_sleeve_dress.png"),
    [Clothes.SHORT_PANTS]: require("asset/image/clothes/girl/image_shorts_pants.png")
...
export const GirlCharacterCostumePath: { [key in Clothes]?: ImageSourcePropType } = {
    ...
    [Clothes.LONG_SLEEVE_DRESS]: require("asset/image/character/girl/image_blouse.png"),
    // 셔츠
