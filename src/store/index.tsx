...
export const WindSpeed = [
    { text: "고요", content: "바람이 불지 않는 고요한 상태가 예상됩니다.", icon: <WindSpeed1 /> },
    { text: "실바람", content: "바람이 거의 느껴지지 않는 약한바람이 예상됩니다.", icon: <WindSpeed2 /> },
    { text: "남실바람", content: "나뭇잎이 흔들리는 정도의 약한바람이 예상됩니다.", icon: <WindSpeed3 /> },
    { text: "산들바람", content: "깃발이 흔들리는 정도의 약한바람이 예상됩니다.", icon: <WindSpeed4 /> },
    { text: "건들바람", content: "나무 가지가 흔들리는 정도의 중간바람이 예상됩니다.", icon: <WindSpeed5 /> },
    { text: "흔들바람", content: "작은 나무가 흔들리는 정도의 중간바람이 예상됩니다.", icon: <WindSpeed6 /> },
    { text: "된바람", content: "우산을 들기가 곤란한 정도의 강한바람이 예상됩니다.", icon: <WindSpeed7 /> },
    { text: "센바람", content: "바람을 마주해 걷기 힘든 강한바람이 예상됩니다.", icon: <WindSpeed8 /> },
    { text: "큰바람", content: "나무가지가 꺾이는 아주 큰 바람이 예상됩니다.", icon: <WindSpeed9 /> },
    { text: "큰센바람", content: "가옥에 손해가 있을 정도의태풍급 바람이 예상됩니다.", icon: <WindSpeed10 /> }
]
