            ...
            <ScrollView>
                <View style={CommonStyle.padding}>
                    ...
                    <View style={[styles.view, styles.padding]}>
                        ...
                        <OpenSource name={"react-native-svg"} link={"https://github.com/software-mansion/react-native-svg"} copyright={"Copyright (c) [2015-2016] [Horcrux]"} />
                    </View>
                    <Text style={[isTablet ? TabletFont.weather_info_main_text : MobileFont.weather_info_main_text, { color: CommonColor.basic_gray_dark }]}>
                        위에 열거된 오픈 소스 라이브러리들은 모두 MIT 라이선스를 사용하고 있으며, 이를 준수하여 '오늘 머입지' 앱을 개발하였습니다. 해당 라이선스에 대한 자세한 내용은 각
